...
const reviews: ReviewType[] = [
  ...
  },
  {
    ...
    review:
      "بدون شک یکی از بهترین سرمایه‌گذاری‌های آموزشی که کردم. این دوره پر از نکات عملیه که بلافاصله می‌تونید در پروژه‌هاتون استفاده کنید. بدون مقدمه‌های طولانی و حرف‌های اضافه. فقط دانش فنی خالص . ",
