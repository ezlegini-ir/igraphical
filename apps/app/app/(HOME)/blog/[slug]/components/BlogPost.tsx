...
import PostGrid, { PostType as MyPostType } from "../../components/PostGrid";
  ...
  return (
    <div className="space-y-5 mb-16">
      <div className="text-center space-y-3 mt-10">
        <div className="flex gap-2 justify-center">
          {post?.categories.map((category) => (
            <div key={category.id}>
              <Link href={`/blog/?category=${category.url}`}>
                <Button
      ...
      <Image
        ...
        alt="post pic"
        className="w-full h-full aspect-square md:aspect-video object-cover rounded-xl"
      />
