    ...
    subMenuItems: [
      {
        ...
        subMenuItems: [
          ...
          { label: "Earnings", href: "/analysis/earnings" },
          { label: "Coupons", href: "/analysis/coupons" },
          { label: "Registrations", href: "/analysis/registrations" },
          { label: "Ratings", href: "/analysis/ratings" },
          { label: "Instructors", href: "/analysis/instructors" },
          { label: "Students", href: "/analysis/students" },
          { label: "Tickets", href: "/analysis/tickets" },
        ],
      },
